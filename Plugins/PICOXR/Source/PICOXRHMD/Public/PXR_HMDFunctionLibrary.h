...
#pragma region Boundary
	...
	*/
	...
	/// <summary>Sets the camera image as the background.
	/// @note This API is not applicable to UE 4.24 and 4.25, and applicable to UE 4.26, 4.27.
	/// </summary>
...
#pragma  endregion Boundary
	...
	/// <summary>Sets a foveated rendering level.
	/// @note To call `PXR Set Foveated Rendering Level`, you need to enable foveated rendering.
	/// </summary>
	...
	*/
	...
	UFUNCTION(BlueprintCallable, Category = "PXR|PXRHMD")
	static float PXR_GetTrackingOriginHeight();
};
